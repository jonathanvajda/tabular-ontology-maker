...
const APP_VERSION = 'v0.1.0';                  // bump on each release
...
const PRECACHE_MANIFEST = [
  ...
  { url: './lib/handsontable.full.css',   revision: 'static' },
  { url: './lib/handsontable.full.js',    revision: 'static' },
  { url: './lib/n3.min.js',               revision: 'static' },
  { url: './lib/xlsx.full.min.js',        revision: 'static' },
  // libraries you ship locally:
  { url: './index.html',                  revision: 'v0.1.1' },
  { url: './index-dev.html',              revision: 'v0.1.1' },
  { url: './favicon.ico',                 revision: 'v0.1.1' },
  { url: './lib/ontology_spreadsheet.js', revision: 'v0.1.1' },
